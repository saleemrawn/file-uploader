...
export const getFolderByUuid = async (uuid) => {
  const folder = await prisma.shareLink.findUnique({
...
export const createFolderShareLink = async ({ uuid, folderId, ownerId, expiryDuration }) => {
